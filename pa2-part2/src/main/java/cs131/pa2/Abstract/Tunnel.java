...
public abstract class Tunnel {
    ...
    /**
     * Condition variable that shares with vehicles
     */
    private Condition cond;

    /**
     * boolean flag that indicates whether ambulance is in the tunnel
     */
    private boolean hasAmbulance;

    /**
     * lock used to lock field;
     */
     ...
     *
     * @param cond new condition variable to be set
     */
    ...
    /**
     * check whether the tunnel has ambulance in it
     *
     * @return true if there is an ambulance in this tunnel
     */
    ...
    /**
     * lock the field and change its state
     *
     * @param bool new boolean flag for this field
     */
    public void setHasAmbulance(boolean bool) {
        // acquire lock
        lock.lock();
        try {
            this.hasAmbulance = bool;
        } finally {
            lock.unlock();
        }
    }
